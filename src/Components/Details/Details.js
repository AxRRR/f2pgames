        ...
        <Modal onClose={props.onClose}>
          <Card>
            <div className={classes.gameinfo}>
              <p>{gdetails.title}</p>
              <p className={classes.title}>{gdetails.developer}</p>
            </div>
            <img
            ...
            <div className={classes.specinfo}>
              <p className={classes.text}>Description: {gdetails.short_description}</p>
              <p className={classes.text}>Release: {gdetails.release_date}</p>
              <p className={classes.text}>Visit de Original webside: {gdetails.game_url}</p>
            ...
            <div className={classes.specbox}>
              ...
              <p className={classes.text}>
                {gdetails.minimum_system_requirements.memory}
              </p>
              <p className={classes.text}>
                {gdetails.minimum_system_requirements.processor}
              </p>
              <p className={classes.text}>
